...
export interface ocr_scanned_documentAttributes {
  id: number;
...
export type ocr_scanned_documentPk = "id";
export type ocr_scanned_documentId = ocr_scanned_document[ocr_scanned_documentPk];
export type ocr_scanned_documentOptionalAttributes = "id" | "wf_display_id" | "wf_info_id" | "synced_at" | "document_id" | "s3_path" | "s3_name" | "file_text" | "csv_files_locations" | "form_fields" | "document_processed" | "total_pages" | "tax_period" | "tax_year" | "tax_form" | "amount_due" | "agency_form_number" | "payment_type" | "amount_type" | "credit_amount" | "payment_amount" | "tax_amount" | "penalty_amount" | "interest_amount" | "fine_amount" | "fee_amount" | "tax_refund_amount" | "penalty_refund_amount" | "interest_refund_amount" | "major_rate_1" | "minor_rate_1" | "minor_rate_2" | "minor_rate_3" | "rate_start_date" | "sdi_rate" | "issue_date" | "received_date" | "agency_due_date" | "check_date" | "co_due_date" | "follow_up_date" | "due_date" | "inquiry_id" | "agency_type" | "agency_dept_id" | "agency_local_id" | "agency_city_id" | "notice_type_id" | "account_agency_id" | "agency_tax_type_id" | "agency_info_id" | "co_info_id" | "agency_countries_id" | "account_info_id" | "wf_description" | "agency_form_number_id" | "created_at" | "updated_at" | "filing_type_id" | "refund_due" | "sql_notice" | "priority" | "notice_manager" | "seq_notice_id" | "agency_id_to_use" | "agency_id_to_use_value" | "verified" | "query_results" | "textract_process_count" | "parent_id" | "actual_pages";
export type ocr_scanned_documentCreationAttributes = Optional<ocr_scanned_documentAttributes, ocr_scanned_documentOptionalAttributes>;

export class ocr_scanned_document extends Model<ocr_scanned_documentAttributes, ocr_scanned_documentCreationAttributes> implements ocr_scanned_documentAttributes {
  id!: number;
  wf_display_id?: number;
  wf_info_id?: number;
  synced_at?: Date;
  ...
  // ocr_scanned_document belongsTo account_agency via account_agency_id
  ...
  // ocr_scanned_document belongsTo account_info via account_info_id
  ...
  // ocr_scanned_document belongsTo agency_city via agency_city_id
  ...
  // ocr_scanned_document belongsTo agency_country via agency_countries_id
  ...
  // ocr_scanned_document belongsTo agency_department via agency_dept_id
  ...
  // ocr_scanned_document belongsTo agency_form_number via agency_form_number_id
  ...
  // ocr_scanned_document belongsTo agency_info via agency_info_id
  ...
  // ocr_scanned_document belongsTo agency_local via agency_local_id
  ...
  // ocr_scanned_document belongsTo app_user_info via created_by
  ...
  // ocr_scanned_document belongsTo co_info via co_info_id
  co_info!: co_info;
  ...
  // ocr_scanned_document belongsTo sys_workflow via notice_type_id
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof ocr_scanned_document {
  ...
  }) as typeof ocr_scanned_document;
  }
}
